...
//	private File file;
	...
	public CalculateTask_si_verify(int Times,KeyPair keypair, BigInteger plaintext, BLS01 bls01, AsymmetricCipherKeyPair AsykeyPair,
	...
	protected Integer compute() {
		...
		if(canCompute) {
			...
			int middle = Times / 2;
			CalculateTask_si_verify taskLeft = new CalculateTask_si_verify( middle , keypair,  plaintext, bls01, AsykeyPair, cipher, signature);
			CalculateTask_si_verify taskRight = new CalculateTask_si_verify(Times - middle, keypair,  plaintext, bls01,AsykeyPair, cipher, signature);
