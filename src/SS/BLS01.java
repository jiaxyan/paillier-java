...
//	   setup.init(PairingFactory.getPairingParameters("D:\\paillierExp\\jpbc-2.0.0\\params\\curves\\a.properties"));
	   try {
		String dir = directory.getCanonicalPath();
		setup.init(PairingFactory.getPairingParameters(dir+"/a.properties"));
   ...
   public static void main(String[] args) {
       ...
       System.out.println(bls01.sign(message, AsykeyPair.getPrivate()));
       assertTrue(bls01.verify(bls01.sign(message, AsykeyPair.getPrivate()), message, AsykeyPair.getPublic()));
       System.out.println("verify Hello Wrold ok!");
       // Test different messages
       assertFalse(bls01.verify(bls01.sign(message, AsykeyPair.getPrivate()), "Hello Italy!", AsykeyPair.getPublic()));
       System.out.println("verify Hwllo Italy ok!");
   }
